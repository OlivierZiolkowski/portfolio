...
const informations = {
    ...
    firstPar: "Développeur web front-end depuis 2020 avec un passé dans différents métiers du numérique. Intéressé par l'expérience utilisateur, j'aime apprendre et transmettre mes acquis !",
